...
| 53 | [House Robber](./dynamic-programming/house-robber) | 1D DP / Take-or-Skip | Medium |
| 54 | [Jump Game](./dynamic-programming/jump-game) | Greedy/DP | Medium |
| 55 | [Unique Paths](./dynamic-programming/unique-paths) | 2D Grid DP | Medium |
| 56 | [Cherry Pickup II](./dynamic-programming/cherry-pickup-ii) | 2D DP | Hard |
| 57 | [Number of Ways to Paint N×3 Grid](./dynamic-programming/number-of-ways-paint-grid) | DP/Combinatorics | Hard |
| 58 | [Partition Equal Subset Sum](./dynamic-programming/partition-equal-subset-sum) | 0-1 Knapsack | Medium |
| 59 | [Longest Increasing Subsequence](./dynamic-programming/longest-increasing-subsequence) | DP / Patience Sorting | Medium |
| 60 | [Longest Increasing Subsequence II](./dynamic-programming/longest-increasing-subsequence-ii) | DP + Segment Tree (range-max) | Hard |
| 61 | [Russian Doll Envelopes](./dynamic-programming/russian-doll-envelopes) | 2-D LIS (sort + patience) | Hard |
| 62 | [Number of LIS](./dynamic-programming/number-of-lis) | Counting DP (reset/accumulate) | Medium |
| 63 | [Largest Divisible Subset](./dynamic-programming/largest-divisible-subset) | LIS / Poset Chain | Medium |
| 64 | [Burst Balloons](./dynamic-programming/burst-balloons) | Interval DP | Hard |
| 65 | [Subsets](./dynamic-programming/subsets) | Backtracking | Medium |
| 66 | [Permutations](./dynamic-programming/permutations) | Backtracking | Medium |
| 67 | [Combination Sum](./dynamic-programming/combination-sum) | Backtracking | Medium |
| 68 | [Combination Sum II](./dynamic-programming/combination-sum-ii) | Backtracking (dedupe) | Medium |
| 69 | [Combination Sum IV](./dynamic-programming/combination-sum-iv) | Counting DP (compositions) | Medium |
| 70 | [Coin Change II](./dynamic-programming/coin-change-ii) | Counting DP (partitions) | Medium |
| 71 | [Inverse Coin Change](./dynamic-programming/inverse-coin-change) | Inverse DP (gen. function) | Medium |
| 72 | [Word Search](./dynamic-programming/word-search) | Backtracking / 2D Grid | Medium |
| 73 | [Shortest Common Supersequence](./dynamic-programming/shortest-common-supersequence) | LCS / 2D DP | Hard |

### Trees
| # | Problem | Topic | Difficulty |
|---|---------|-------|------------|
| 74 | [Populating Next Right Pointers II](./trees/populating-next-right-pointers-ii) | BFS | Medium |
| 75 | [Delete Nodes and Return Forest](./trees/delete-nodes-and-return-forest) | DFS | Medium |
| 76 | [LCA of Deepest Leaves](./trees/lca-deepest-leaves) | DFS | Medium |
| 77 | [All Possible Full Binary Trees](./trees/all-possible-full-binary-trees) | Recursion/Memo | Medium |
| 78 | [Binary Search Tree Iterator](./trees/binary-search-tree-iterator) | Stack/Design | Medium |
| 79 | [Lowest Common Ancestor](./trees/lowest-common-ancestor) | DFS | Medium |
| 80 | [Binary Tree Maximum Path Sum](./trees/binary-tree-max-path-sum) | DFS | Hard |
| 81 | [Validate BST](./trees/validate-bst) | DFS / Range Passing | Medium |

### Graphs
| # | Problem | Topic | Difficulty |
|---|---------|-------|------------|
| 82 | [Clone Graph](./graphs/clone-graph) | BFS/DFS | Medium |
| 83 | [Find if Path Exists](./graphs/find-if-path-exists) | BFS/DFS/DSU | Easy |
| 84 | [Number of Islands](./graphs/number-of-islands) | BFS/DFS/DSU | Medium |
| 85 | [Rotting Oranges](./graphs/rotting-oranges) | Multi-Source BFS | Medium |
| 86 | [01 Matrix](./graphs/01-matrix) | Multi-Source BFS | Medium |
| 87 | [Shortest Path in Binary Matrix](./graphs/shortest-path-binary-matrix) | BFS | Medium |
| 88 | [Word Ladder](./graphs/word-ladder) | BFS/Implicit Graph | Hard |
| 89 | [Max Area of Island](./graphs/max-area-of-island) | DFS/BFS | Medium |
| 90 | [Pacific Atlantic Water Flow](./graphs/pacific-atlantic-water-flow) | Multi-Source BFS | Medium |
| 91 | [Surrounded Regions](./graphs/surrounded-regions) | BFS/Union-Find | Medium |
| 92 | [Number of Provinces](./graphs/number-of-provinces) | DFS/BFS/DSU | Medium |
| 93 | [Course Schedule](./graphs/course-schedule) | Topological Sort | Medium |
| 94 | [Course Schedule II](./graphs/course-schedule-ii) | Topological Sort | Medium |
| 95 | [Parallel Courses III](./graphs/parallel-courses-iii) | Topological Sort + DP (critical path) | Hard |
| 96 | [Find Eventual Safe States](./graphs/find-eventual-safe-states) | DFS/Cycle Detection | Medium |
| 97 | [Alien Dictionary](./graphs/alien-dictionary) | Topological Sort | Hard |
| 98 | [Is Graph Bipartite?](./graphs/is-graph-bipartite) | BFS/DFS | Medium |
| 99 | [Possible Bipartition](./graphs/possible-bipartition) | BFS/DFS/DSU | Medium |
| 100 | [Redundant Connection](./graphs/redundant-connection) | Union-Find | Medium |
| 101 | [Accounts Merge](./graphs/accounts-merge) | Union-Find | Medium |
| 102 | [Most Stones Removed](./graphs/most-stones-removed) | Union-Find | Medium |
| 103 | [Evaluate Division](./graphs/evaluate-division) | BFS/Weighted | Medium |
| 104 | [Network Delay Time](./graphs/network-delay-time) | Dijkstra's | Medium |
| 105 | [Path with Minimum Effort](./graphs/path-minimum-effort) | Dijkstra's/BST/DSU | Medium |
| 106 | [Cheapest Flights Within K Stops](./graphs/cheapest-flights-k-stops) | Bellman-Ford | Medium |
| 107 | [Swim in Rising Water](./graphs/swim-in-rising-water) | Dijkstra's/BST/DSU | Hard |
| 108 | [Min Cost to Connect All Points](./graphs/min-cost-connect-points) | MST/Prim's/Kruskal's | Medium |
| 109 | [Connecting Cities With Min Cost](./graphs/connecting-cities-min-cost) | MST/Kruskal's | Medium |
| 110 | [Critical Connections](./graphs/critical-connections) | Tarjan's Bridge | Hard |
| 111 | [Minimum Height Trees](./graphs/minimum-height-trees) | BFS/Topological | Medium |

### Design
| # | Problem | Topic | Difficulty |
|---|---------|-------|------------|
| 112 | [LRU Cache](./design/lru-cache) | DLL + HashMap | Medium |
| 113 | [Exam Room](./design/exam-room) | Sorted Set | Medium |
| 114 | [Find Median from Data Stream](./design/find-median-data-stream) | Two Heaps | Hard |

### Bit Manipulation
| # | Problem | Topic | Difficulty |
|---|---------|-------|------------|
| 115 | [Number of 1 Bits](./bit-manipulation/hamming-weight) | Bit Manipulation | Easy |
| 116 | [Reverse Bits](./bit-manipulation/reverse-bits) | Bit Manipulation | Easy |

### Binary Search (Advanced)
| # | Problem | Topic | Difficulty |
|---|---------|-------|------------|
| 117 | [Lowest Common Ancestor (Binary Tree)](./trees/lowest-common-ancestor) | DFS | Medium |
...
---
> 121 problems · 16 guides · Complete Staff/Principal Engineer preparation resource

> Last updated: 2026-07-05 — added LIS II (#2407): segment-tree range-max DP + the Longest Upgrade Path variant (a non-transitive DAG)
