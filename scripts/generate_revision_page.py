...
@media(max-width:768px){.sidebar{display:none}.main{padding:1rem}}.sidebar-group{font-size:.65rem;font-weight:700;color:var(--muted);padding:.65rem 1rem .2rem;text-transform:uppercase;letter-spacing:.1em;border-top:1px solid var(--border);margin-top:.25rem}.sidebar li a{display:flex!important;align-items:center;gap:.5rem}.sidebar li a.active{color:var(--accent)!important;border-left-color:var(--accent)!important;background:#e8f0fb!important;font-weight:600}.nav-icon{font-size:.85rem;flex-shrink:0;opacity:.75}.nav-count{margin-left:auto;font-size:.65rem;font-weight:600;padding:.1rem .35rem;border-radius:8px;background:var(--surface2);color:var(--muted)}.sidebar li a.active .nav-count{background:#d0e4fb;color:var(--accent)}.topic-section{display:none}section.topic-section.active{display:block}.section-title{font-size:1.05rem;font-weight:700;color:var(--text);border-bottom:2px solid var(--border);padding-bottom:.75rem;margin:0 0 1.5rem;display:flex;align-items:center;gap:.5rem}.section-title-count{margin-left:auto;font-size:.72rem;padding:.25rem .7rem;border-radius:20px;background:var(--surface2);color:var(--muted);border:1px solid var(--border);font-weight:500}.topic-section{display:none}section.topic-section.active{display:block}.sidebar-group{font-size:.65rem;font-weight:700;color:var(--muted);padding:.65rem 1rem .2rem;text-transform:uppercase;letter-spacing:.1em;border-top:1px solid var(--border);margin-top:.3rem}.sidebar li a{display:flex!important;align-items:center;gap:.5rem}.sidebar li a.active{color:var(--accent)!important;border-left-color:var(--accent)!important;background:#e8f0fb!important;font-weight:600}.nav-icon{font-size:.85rem;flex-shrink:0;opacity:.75}.nav-count{margin-left:auto;font-size:.65rem;font-weight:600;padding:.1rem .35rem;border-radius:8px;background:var(--surface2);color:var(--muted)}.sidebar li a.active .nav-count{background:#d0e4fb;color:var(--accent)}.section-title{font-size:1.05rem;font-weight:700;color:var(--text);border-bottom:2px solid var(--border);padding-bottom:.75rem;margin:0 0 1.5rem;display:flex;align-items:center;gap:.5rem}.section-title-count{margin-left:auto;font-size:.72rem;padding:.25rem .7rem;border-radius:20px;background:var(--surface2);color:var(--muted);border:1px solid var(--border);font-weight:500}
"""
